...
const AudioVisualiser = () =>
{
    ...
    let fileUrl = useRef( 'http://localhost:3001/api/v1/audioFiles/getFile/63357c719836dde2b7005474' );
    //let fileInfoUrl = useRef('http://localhost:3001/api/v1/audioFiles/getFileInfo/63299fff95f55c20e3e08ae0');
    let fileInfoUrl = useRef( 'http://localhost:3001/api/v1/audioFiles/getFileInfo/63357c719836dde2b7005474' );
    ...
    {
        let initHeaders = {
            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2MzM1ODg2NDkyMzdmNjFkMzA3NDQxOWUiLCJ1c2VybmFtZSI6ImFkbWluIiwicm9sZSI6IkJhc2ljIiwiaWF0IjoxNjY0NDUyNzA5LCJleHAiOjE2NjQ1MzkxMDl9.3klHGJXf3iBfJ5ift0tK5ISNMjjh0jl6WcfRYa2ICps',
        }
